...
pub(super) const MAX_LATTICE_RINGS: f32 = 128.0;
pub(super) const MAX_LON_DENSITY: f32 = 256.0;
pub(super) const MAX_ORBIT_N: f32 = 64.0;
pub(super) const MAX_GHOST_N: f32 = 512.0;
pub(super) const MAX_PARTICLES: f32 = 16.0;
pub const MAX_NODE_N: f32 = 128.0;
pub(super) const MAX_SIGNALS: f32 = 64.0;
pub(super) const MAX_STRAND_N: f32 = 256.0;
pub(super) const MAX_LANES: f32 = 32.0;
pub(super) const MAX_SEGS: f32 = 512.0;
pub(super) const MAX_MOVE_COUNT: f32 = 64.0;
...
pub fn scale_radii(opts: &ModeOpts, scale: f32) -> ModeOpts {
    ...
    let mul =
        |v: Option<f32>| v.and_then(|x| x.is_finite().then_some(x * scale));
